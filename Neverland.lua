...
screen -S ]]..Redis:get(SshId.."Info:Redis:Token:User")..[[ ./TheNeverland
done
]])
Run:close()
...
return {
Lock     = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[TeAmNeverland ›](https://t.me/TeAm_Neverland)\n*— — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if text == 'رفع نسخه نيفرلاند' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم استرجاع المجموعات من نسخه نيفرلاند')
else
...
download('https://raw.githubusercontent.com/KAFIKAFII/KAFI/master/Neverland.lua','Neverland.lua')
...
{
{text = 'TeAmNeverland ›', url = 't.me/TeAm_Neverland'},
},
}
}
if not msg.ControllerBot then
...
Redis:del(TheNeverland.."Neverland:Status:yt"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تعطيل اليوتيوب')
return false
end 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/RapEthan/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "شعر" or text == "اشعار" then 
alsh = math.random(2,592); 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/fasngon/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/MoviesDavid/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/AnimeDavid/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/PhotosDavid/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/GifDavid/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/RemixDavid/'..alsh..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
--------------------------------------------------------------------------------------------------------------
...
local TextingDevTheNeverland = Redis:get(TheNeverland..'Neverland:Texting:DevTheNeverland')
if TextingDevTheNeverland then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevNeverland,"md",true)  
else
...
if Redis:get(TheNeverland.."Neverland:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
{
{text = 'Facebook', url = 'https://www.facebook.com/help/deleteaccount'},{text = 'Snapchat', url = 'https://accounts.Snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.Neverlandchat.com%2Faccounts%2Fdeleteaccount'}
},
{
{text = 'TeAmNeverland ›', url = 't.me/TeAm_Neverland'}, 
},
...
{
{text = '‹ 𝗗𝗘𝗩 𝗦𝗢𝗨𝗥𝗖𝗘 ›', url = "https://t.me/XCGCC"},{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘾𝙃 .', url = "https://t.me/TeAm_Neverland"}
},
{
{text = '‹ 𝙏𝙒𝙎 𝙄𝘽𝙊 ›', url = "https://t.me/XCGCC"}
},
{
{text = '‹ 𝙎𝙊𝙐𝙍𝘾𝙀 𝘾𝘼𝙃𝙃𝙉𝙀𝙇 ›', url = "https://t.me/TeAm_Neverland"}
},
}
local msgg = msg_id/2097152/0.5
...
data = {
{
{text = '᥀ السورس .', url = 't.me/TeAm_Neverland'},{text = '᥀ لتنصيب بوت .', url = 't.me/vxhjdj'}, 
},
{
